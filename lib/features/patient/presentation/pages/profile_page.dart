    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Row(
            children: [
              AvatarWidget(name: user.fullName, size: 56, imagePath: user.avatarUrl),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(user.email, style: TextStyle(fontSize: 12.5, color: colors.textSecondary)),
                  ],
                ),
              ),
            ],
            ...
            GroupedList(
              ...
              children: [
                ...
                GroupedListTile(
                  ...
                  detail: profile.allergies.isEmpty ? 'None' : profile.allergies.join(', '),
                  onTap: () => showEditHealthProfileSheet(context, ref, profile),
                ),
                GroupedListTile(
